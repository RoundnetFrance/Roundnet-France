...
function SignUpOAuthForm({ clubs, hiddenFields }) {
  ...
  const descriptionBefore = "Pour finaliser la création de votre compte, vous devez entrer les détails suivants.";
  ...
  return (
    formConfig ? <FormBuilder formConfig={formConfig} /> : null
  )
}
