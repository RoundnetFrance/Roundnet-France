...
const fourSquareContent = [
  {
    ...
    content: [
      "Chaque saison, les joueurs français de roundnet participent à une multitude de tournois. Roundnet France organise deux types de tournois: la coupe de France et le championnat de France des clubs. La coupe de France s’agit de 4 Tour Stops (tournois) et le championnat de France. Cela détermine les champions et championnes de France.",
      "Le championnat de France des clubs est un nouveau format ou les clubs membres de la fédération s'affrontent entre eux. Un seul club en sortira champion ! Pour plus d’informations et pour répondre à vos questions, allez consulter les pages dédiées à ces compétitions.",
    ],
    links: [
      {
      ...
      {
        href: "/competition/championnat-de-france-des-clubs",
        text: "Championnat de France des clubs",
      },
    ],
    icon: "verified",
  },
