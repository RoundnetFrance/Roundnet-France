  ...
  const items = [
    {
      ...
      title: "Inclusivité",
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, facere. Molestias error, reprehenderit autem asperiores explicabo reiciendis.",
    },
    {
      id: "2",
      icon: "restart_alt",
      title: "Fair play",
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, facere. Molestias error, reprehenderit autem asperiores explicabo reiciendis. Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: "3",
      ...
      title: "Progrès",
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, facere. Molestias error, reprehenderit autem asperiores explicabo reiciendis. Lorem ipsum dolor.",
    },
    {
      id: "4",
      icon: "emoji_events",
      title: "Compétitivité",
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, facere. Molestias error, reprehenderit. Lorem ipsum dolor sit amet.",
    },
  ];

  return (
    <Fragment>
      <Head title="Le projet associatif - Fédération Française de Roundnet" />
      ...
      <Container maxWidth="md" sx={{ my: 4 }}>
        ...
        <Typography variant="body1" sx={{ pb: 4 }}>
          ...
          Necessitatibus quae ipsum quisquam quis numquam, odit vel
          exercitationem accusamus dolore deserunt iusto dicta id deleniti
          dolores et ipsa, magnam animi debitis dolorem pariatur architecto quo
          repellendus asperiores odio. Vitae quia sed autem ab in, ipsam
          blanditiis, repellendus eos itaque iure illo deleniti doloribus
          tempora, quam ex iste necessitatibus provident. Voluptates iusto
          ducimus libero voluptas id.
        </Typography>
      </Container>
      ...
      <Container maxWidth="lg" sx={{ my: 4 }}>
        <Box my={4}>
          <HeaderWithIcon icon="recommend" title="Nos valeurs" />
        </Box>
